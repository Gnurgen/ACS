...
public class BookStoreTest {
	...
	public void testGetTopRatedBooks() throws BookStoreException{
		...
		ratings.add(new BookRating(TEST_ISBN + 1, 3));
		ratings.add(new BookRating(TEST_ISBN + 2, 1));
		ratings.add(new BookRating(TEST_ISBN + 3, 5));
		...
		assertTrue(topRated.size() == 2 && 
				   isbns.contains(topRated.get(0).getISBN()) && 
				   isbns.contains(topRated.get(1).getISBN()));
	}
	
	@Test
	public void testGetTopRatedInvalidNum() throws BookStoreException{
		Set<StockBook> booksToAdd = new HashSet<StockBook>();
		booksToAdd.add(new ImmutableStockBook(TEST_ISBN + 1,
				"This is the book!", "A. Writer", (float) 300,
				NUM_COPIES, 0, 0, 0, false));
		...
		try{
			...
			System.out.println(BookStoreConstants.INVALID_NUM);
			System.out.println(ex.getMessage() == BookStoreConstants.INVALID_NUM);
			assertTrue(ex.getMessage().equals(BookStoreConstants.INVALID_NUM));
		}
	}
	...
	public void testRateInvalidRating() throws BookStoreException{
		...
		ratings.add(new BookRating(TEST_ISBN + 1, 3));
		ratings.add(new BookRating(TEST_ISBN + 2, 1));
		ratings.add(new BookRating(TEST_ISBN + 3, 6));
	...
	public void testRateInvalidIsbn() throws BookStoreException{
		...
		ratings.add(new BookRating(TEST_ISBN + 1, 3));
		ratings.add(new BookRating(TEST_ISBN + 2, 1));
		ratings.add(new BookRating(TEST_ISBN + 4, 5));
