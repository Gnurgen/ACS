...
public final class BookStoreConstants {
	...
	public static final String INVALID_NUM = "Number of books must be above 0";
	public static final String INSUFFICIENT_BOOKS = "Not enough books in store";
	public static final String INVALID_RATING = "Rating must be 0 =< rating <= 5";
