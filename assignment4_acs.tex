...
As we can in the transaction table above the set of winner transaction is \{T3\}, as this T3 finishes before the crash, the set of losers are \{T1,T2\}, as they are both active when the crash happens.
